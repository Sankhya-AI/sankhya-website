    ...
    <main className="bg-cream">
      <article>
        ...
        <div className="px-8 pt-40 pb-24 sm:px-12 md:pt-52 lg:px-16 xl:px-8">
          <div className="mx-auto grid max-w-[1180px] gap-14 lg:grid-cols-[minmax(0,760px)_260px] lg:gap-24 xl:gap-32">
            <div className="max-w-[760px] font-sans text-[19px] leading-[1.76] text-[#2b2927] md:text-[21px]">
