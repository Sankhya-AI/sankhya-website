...
export function Blog() {
  ...
  return (
    <section id="blog" className="flex min-h-[calc(100svh-112px)] w-full flex-col border-y border-[#c9c2ba] bg-cream">
      <div className={`grid flex-1 ${hasSideArticles ? 'md:grid-cols-[60%_40%]' : ''}`}>
        <Link
