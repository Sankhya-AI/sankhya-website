...
export const DEFAULT_DESCRIPTION =
  'Sankhya AI Labs builds information infrastructure for AI agents: shared memory, context routing, and execution fabric for systems that learn across tools, teams, and time.';
