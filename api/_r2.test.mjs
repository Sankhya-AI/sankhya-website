...
test('the product is read from the artifact name, so upload and read cannot disagree', () => {
  ...
  assert.equal(productForArtifact('plank-darwin-arm64.dmg'), 'plank');
});
